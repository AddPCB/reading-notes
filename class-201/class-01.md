...
// the === just threw it's hands up because it doesn't put up with ambiguity. This is useful, because we wouldn't want to confuse 3 and 21 if the result is later used in further math or logic.
